--doTargetMagic
 ...
 UltimateHealingObject = MagicDamageObject(attackType,Targetpos, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)
 ...
 function onCast(cid, creaturePos, level, maglv, var)
 centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}
 ret = doTargetMagic(cid, Targetpos, UltimateHealingObject:ordered())
 if(ret) then
