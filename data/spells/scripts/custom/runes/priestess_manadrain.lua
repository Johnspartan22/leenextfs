...
PriestessManaDrain = MagicDamageObject(attackType, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)

function onCast(cid, creaturePos, level, maglv, var)
	centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}

	PriestessManaDrain.minDmg = 25000
	PriestessManaDrain.maxDmg = 55000

	return doTargetMagic(cid, centerpos, PriestessManaDrain:ordered())
end
