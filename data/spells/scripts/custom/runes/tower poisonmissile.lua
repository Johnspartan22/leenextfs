...
PoisonMissile = MagicDamageObject(attackType, animationEffect, hitEffect, damageEffect, animationColor, offensive, drawblood, 0, 0)

function onCast(cid, creaturePos, level, maglv, var)
centerpos = {x=creaturePos.x, y=creaturePos.y, z=creaturePos.z}

PoisonMissile.minDmg = 8000
PoisonMissile.maxDmg = 15000

return doTargetMagic(cid, centerpos, PoisonMissile:ordered())
end
