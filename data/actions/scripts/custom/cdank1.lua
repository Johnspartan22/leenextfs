function onUse(cid, item, fromPosition, itemEx, toPosition)
    -- Configuration
    local wallPos = {x = 2177, y = 1028, z = 8, stackpos = 1} -- Replace with your wall coordinates
    local wallID = 1060 -- Replace with your wall ID (1544 is a common wall ID in Tibia)
