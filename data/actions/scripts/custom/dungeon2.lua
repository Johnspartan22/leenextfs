local config = {
    t = 2177, -- ITEM THAT YOU WILL USE
    p = {x=1692, y=700, z=8}, -- WHERE THE HELL AM I GOING
    exitCoords = {x=1679, y=668, z=8}, -- COORDINATES THAT CLEAR PLAYER FROM ACTIVE LIST
    rewardsRoom = {x=1693, y=627, z=8}, -- COORDINATES FOR THE REWARDS ROOM
    requiredItems = {2122, 2125, 2124},
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    if item.itemid == config.t then
        ...
        if hasRequiredItem then
            ...
            doPlayerSendTextMessage(cid, 18, "[DUNGEON SYSTEM] You have entered an D rank Dungeon. You have 15 minutes to complete it!")
