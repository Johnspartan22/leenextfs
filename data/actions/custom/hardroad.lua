function onUse(cid, item, frompos, item2, topos)
    local piece1pos = {x=24, y=37, z=8, stackpos=255}
    local getpiece1 = getThingfromPos(piece1pos)
    local playerpos = getPlayerPosition(cid)
    local nplayer1pos = {x=220, y=363, z=8}
    ...
    -- Check for actionid 6369 and that it's a lever (itemid 1945)
    if item.actionid == 6369 and item.itemid == 1945 and getpiece1 and getpiece1.itemid == 2194 then
